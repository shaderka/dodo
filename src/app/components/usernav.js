		...
		<div className='flex rounded-md justify-center mb-10' role='group'>
			<Link
				...
				className={
					...
					(isAdmin ? 'rounded-s-lg ' : 'rounded-lg ') +
					'px-4 py-2 text-sm font-medium text-gray-600 bg-transparent border border-gray-600 hover:bg-primary hover:text-white focus:z-10 focus:ring-2 focus:ring-orange-300 focus:bg-primary focus:text-white hover:border-primary focus:border-primary'
				}
			>
				Профиль
			</Link>
